...
class Cost(BaseModel):
    ...
    provider: Annotated[cost_provider.CostProvider | None, Field(description='The cost provider which incurred the cost.', examples=['aws'])] = None
    billing_account_id: Annotated[str | None, Field(description="The cost provider's billing account id that incurred the cost.", examples=['9109237192'])] = None
    account_id: Annotated[str | None, Field(description="The cost provider's account id that incurred the cost.", examples=['9109237192'])] = None
