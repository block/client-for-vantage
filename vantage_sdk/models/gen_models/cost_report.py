...
from . import attached_business_metric_for_cost_report
from . import chart_settings as chart_settings_1
from . import settings as settings_1
...
class CostReport(BaseModel):
    ...
    business_metric_tokens_with_metadata: Annotated[
        Sequence[
            attached_business_metric_for_cost_report.AttachedBusinessMetricForCostReport
        ],
        Field(
    ...
    settings: Annotated[
        settings_1.Settings | None, Field(description='Report settings.')
    ] = None
    ...
    date_interval: Annotated[
        str, Field(description='The date interval of the CostReport.')
    ]
