...
class CreateResourceReport(BaseModel):
    ...
    workspace_token: Annotated[str, Field(description='The token of the Workspace to add the ResourceReport to.')]
    ...
    folder_token: Annotated[str | None, Field(description='The token of the Folder to add the ResourceReport to.')] = None
