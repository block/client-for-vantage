...
from . import date_interval10, flow_direction1, flow_weight1, grouping1
...
class UpdateNetworkFlowReport(BaseModel):
    ...
    date_interval: Annotated[
        date_interval10.DateInterval | None,
        Field(
    ...
    groupings: Annotated[
        Sequence[grouping1.Grouping] | None,
        Field(
