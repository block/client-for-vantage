...
from . import create_business_metric_cost_report_tokens_with_metadatum_calculation_type, create_business_metric_cost_report_tokens_with_metadatum_unit_scale
...
class CreateBusinessMetricCostReportTokensWithMetadatum(BaseModel):
    ...
    calculation_type: Annotated[create_business_metric_cost_report_tokens_with_metadatum_calculation_type.CreateBusinessMetricCostReportTokensWithMetadatumCalculationType, Field(description='The calculation type applied when this BusinessMetric is used in the CostReport.')] = create_business_metric_cost_report_tokens_with_metadatum_calculation_type.CreateBusinessMetricCostReportTokensWithMetadatumCalculationType.unit_cost
