...
from . import date_bucket as date_bucket_1
from . import date_interval5
from . import on_demand_costs_scope as on_demand_costs_scope_1
...
class CreateFinancialCommitmentReport(BaseModel):
    ...
    date_interval: Annotated[
        date_interval5.DateInterval | None,
        Field(
