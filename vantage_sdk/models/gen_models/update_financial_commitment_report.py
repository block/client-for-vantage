...
from . import date_bucket1, date_interval6, on_demand_costs_scope1
...
class UpdateFinancialCommitmentReport(BaseModel):
    ...
    date_interval: Annotated[
        date_interval6.DateInterval | None,
        Field(
