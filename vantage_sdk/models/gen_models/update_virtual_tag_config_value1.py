...
class UpdateVirtualTagConfigValue(BaseModel):
    ...
    filter: Annotated[str | None, Field(description='The filter query language to apply to the value. Additional documentation available at https://docs.vantage.sh/vql.')] = None
    ...
    percentages: Sequence[update_virtual_tag_config_value1_percentage.UpdateVirtualTagConfigValue1Percentage] | None = None
    date_ranges: Annotated[Sequence[update_virtual_tag_config_value1_date_range.UpdateVirtualTagConfigValue1DateRange] | None, Field(description='Date ranges restricting when this value applies.')] = None
