...
from . import date_interval9
from . import flow_direction as flow_direction_1
from . import flow_weight as flow_weight_1
...
class CreateNetworkFlowReport(BaseModel):
    ...
    date_interval: Annotated[
        date_interval9.DateInterval | None,
        Field(
    ...
    groupings: Annotated[
        Sequence[grouping.Grouping] | None,
        Field(
