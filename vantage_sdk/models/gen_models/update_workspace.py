...
class UpdateWorkspace(BaseModel):
    ...
    exchange_rate_date: Annotated[update_workspace_exchange_rate_date.UpdateWorkspaceExchangeRateDate, Field(description='The date to use for currency conversion.')] = update_workspace_exchange_rate_date.UpdateWorkspaceExchangeRateDate.daily_rate
